...
import { Receipt, DollarSign, Calendar, Tag, User } from 'lucide-react'
...
export const NewExpenseModal = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Registrar Gasto Directo">
      {error && (
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Ej. Supermercado Coto, Luz / Gas, Netflix"
        ...
        >
          {loading ? 'Guardando gasto...' : 'Guardar Gasto Directo'}
        </button>
      </form>
    </Modal>
  )
